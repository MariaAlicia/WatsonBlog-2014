...
<html lang="en" dir="ltr">
	<head> 	<!-- meta data -->
		...
		<meta name="keywords" content="blog Watson cat litterbox">
	...
	<body>
		...
		<div id="container">
			...
			<div id="article2" class="printonly">
				<?php
					$dir_name = "images";
					echo '<div class="blog-image"><figure><img src="'.$dir_name.'/'.'me-and-the-litterbox.jpg" alt="Watson rolling around in his litterbox."/></figure></div>';
				?>
			</div> <!-- end main column -->
				
			<div id="article2" class="printonly">
				<h1>Me and the litterbox</h1>
				<p>
					Every now and then I just love to annoy my owner and if I'm feeling up to it, I might even gross them out a little.
					For instance, today my owner was being especially annoying by ignoring me in favour of some TV programme that I am
					certain she has already seen. Can you even imagine the horror?
				</p>
				
				<p>
					So obviously, I decided to get a little pay back. Oh sure, I haven't bitten her but that's because I have something
					far better in mind. Once I had managed to lure her up to my litterbox and when I knew I had her attention, I promptly jumped into my litterbox and stretched out in it as though it was my bed. Then just to cement the image in her head I rolled around in it for a bit.
					<br>
					The look on her face was priceless. Definitely would recommend. A++ payback method.
				</p>
			</div>
