...
<html lang="en" dir="ltr">
	<head> 	<!-- meta data -->
		...
		<meta name="keywords" content="blog Watson cat rectangle block curled up">
	...
	<body>
		...
		<div id="container">
			...
			<div id="article2" class="printonly">
				<?php
					$dir_name = "images";
					echo '<div class="blog-image"><figure><img src="'.$dir_name.'/'.'bunched-up-on-bed.jpg" alt="Watson looking like a furry rectangle on a bed."/></figure></div>';
				?>
			</div> <!-- end main column -->
				
			<div id="article2">
				<h1>Bunched up on bed</h1>
				<p>
					Oh yes, this will do nicely. I can feel the warmth of the sun from right here, surrounded by the duvet covers. Hmmmmmm.......
					I feel like I should keep writing but I'm just so comfortable here. It's so nice and warm and warm and oh so comfortable.....
				</p>
